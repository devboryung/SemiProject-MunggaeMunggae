...
public class PageInfo { // 페이징 처리를 위한 값을 저장할 객체
							// --> 많은 데이터로 인해 문제를 발생시킬 수 있다. 필요한 데이터만 가져오는 방식으로 처리해야 한다.
	...
	private void makePageInfo() {
		...
		// 페이징바에 페이즈를 10개씩 보여줄 경우
		// 1, 11, 21, 31, ...
		// 현재 페이지가 11p -> 시작 페이지 11
		// 현재 페이지가 15p -> 시작 페이지 11
		// 현재 페이지가 20p -> 시작 페이지 11
		...
		// 10, 20, 30, 40, ...
		// 현재 페이지가 11p -> 시작 페이지 20
		// 현재 페이지가 15p -> 시작 페이지 20
		// 현재 페이지가 20p -> 시작 페이지 20
