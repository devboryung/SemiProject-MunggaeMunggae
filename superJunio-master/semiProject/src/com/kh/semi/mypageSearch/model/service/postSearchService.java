package com.kh.semi.mypageSearch.model.service;
...
import com.kh.semi.mypageSearch.model.dao.postSearchDAO;

public class postSearchService {

	private postSearchDAO dao = new postSearchDAO();
	...
	/** 검색 조건에 따라 SQL에 사용될 조건문을 조합하는 메소드
	   ...
	   private String createCondition(Map<String, Object> map) {
	      ...
	      case "titcont" :
	         condition = " (FREE BOARD_TITLE LIKE '%' || '" + searchValue + "' || '%' "
	 ...
	 * @throws Exception
	 */
	public List<fBoard> fSearchList(Map<String, Object> map, PageInfo pInfo) throws Exception {
		Connection conn = getConnection();
		
		String condition = createCondition(map);
		
		List<fBoard> fList = dao.fSearchList(conn, pInfo, condition);
