package com.kh.semi.mypageSearch.controller;
...
import com.kh.semi.mypageSearch.model.service.postSearchService;
...
public class postSearchController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			// 검색 게시글 목록 조회 
			List<fBoard> fList = service.fSearchList(map, pInfo);
			
			// 조회된 내용과 PageInfo 객체를 request 객체에 담아서 요청 위임
			String path = "/WEB-INF/views/member/myPageInquiryPost.jsp";
