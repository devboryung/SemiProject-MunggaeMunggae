...
<div id="wrapper">
    ...
    <div id="wrapper2">
      <form action="${contextPath}/qna/qnaInsert.do?" method="post" 
      		enctype="multipart/form-data" role="form" onsubmit="return qnaValidate();" >
        ...
        <hr>
        <div>
            <input  id="qnaTitle" name="qnaTitle"type="text"style="width:80%; border:none; margin-left:10px;" placeholder="제목을입력하세요.">
        </div>
            <hr>
        <div>
        ...
        <p style="color:gray; margin-left:10px;">글 공개 여부</p>
           <div style="margin-left:10px;" >
            ...
            <input type="radio" id="private" value="Y" name="publicCheck" checked>
            <label for="public">공개</label>
            <input type="radio" id="public" value="N" name="publicCheck">
          </div>
        <hr>
          <p style="color:gray;margin-left: 10px;">문의내용</p>
          <textarea id="qnaContent"  name="qnaContent" rows="10" style="resize: none; width: 890px; border: 3px solid #8bd2d6;
        ...
        <div class="float-right" style="margin-left:10px;">
            ...
            <button type="button"  onclick="location.href='${goToList}'" 
		class="btn" style="background-color:#8bd2d6; color:white;"><!--  onclick="history.back()" -->취소</button>
        </div>
