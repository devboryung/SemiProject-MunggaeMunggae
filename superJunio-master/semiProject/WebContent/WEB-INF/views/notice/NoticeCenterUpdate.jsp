...
<jsp:include page="/WEB-INF/views/common/otherHeader.jsp"></jsp:include>
 ...
 <form action ="${contextPath}/notice/noticeUpdate.do?cp=${param.cp}&no=${param.no}${searchStr}" method="post"
      enctype="multipart/form-data" role="form" onsubmit="return noticeUpdateValidate();">
<div id="wrapper">
    <div class="aside">
        <ul id="">
    ...
    <div id="wrapper2">
        ...
        <div>
            <input type="text" name="noticeTitle" id="noticeTitle"style="width:80%; border:none;margin-left:10px;" placeholder="제목을입력하세요." value="${notice.noticeTitle}">
            <hr>
        </div>
        <div>
        ...
        <hr>
          ...
          <textarea rows="13" id="noticeContent"name="noticeContent"style="resize: none; width: 890px; border: 3px solid #8bd2d6;
   								 border-radius: 5px;margin-left:10px;">${notice.noticeContent}</textarea> 
...
$(function(){
	  ...
	  $("#noticeFileArea").hide(); // #fileArea 요소를 숨김,
...
$(".boardImg").eq(${file.notiFileLevel}).children("img")
.attr("src","${contextPath}/resources/image/center/noticeImg/${file.notifileName}");
