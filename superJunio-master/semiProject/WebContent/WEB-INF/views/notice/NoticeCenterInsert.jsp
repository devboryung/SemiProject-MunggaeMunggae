...
<jsp:include page="/WEB-INF/views/common/otherHeader.jsp"></jsp:include>
 ...
 <form  action ="${contextPath}/notice/noticeInsert.do" method="post"
...
<div id="wrapper">
    ...
    <div id="wrapper2">
		 ...
		 <div style="margin-left:10px;">
            ...
            <hr>
        <div>
            <input type="text" name="noticeTitle" id="noticeTitle" style="width:80%; border:none;margin-left:10px;" placeholder="제목을입력하세요.">
            <hr>
        </div>
        <div>
