...
<jsp:include page="/WEB-INF/views/common/otherHeader.jsp"></jsp:include>
 ...
 <form action ="${contextPath}/faq/faqUpdate.do?cp=${param.cp}&no=${param.no}${searchStr}" method="post"
      enctype="multipart/form-data" role="form" onsubmit="return faqUpdateValidate();">
<div id="wrapper">
    <div class="aside">
        <ul id="">
    ...
    <div id="wrapper2">
        ...
        <div>
            <input type="text" name="faqTitle" id="faqTitle"style="width:80%; border:none;margin-left:10px;" placeholder="제목을입력하세요." value="${faq.faqTitle}">
            <hr>
        </div>
        <div>
        ...
        <hr>
          ...
          <textarea rows="13" id="faqContent"name="faqContent"style="resize: none; width: 890px; border: 3px solid #8bd2d6;
   								 border-radius: 5px;margin-left:10px;">${faq.faqContent}</textarea> 
...
$(".boardImg").eq(${file.faqFileLevel}).children("img")
.attr("src","${contextPath}/resources/image/center/faqImg/${file.faqFileName}");
